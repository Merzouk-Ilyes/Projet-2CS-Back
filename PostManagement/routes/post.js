...
const {addpost,findAllPosts, DeclinePostWithReason , EditPost , findPostById,UpdatePostById,stats,percent,findPostByIdHost,signalerpost,UpdatePostAvailability,deletePost} = require('../controllers/post')
