...
exports.DeclinePostWithReason = async (req , res ) =>  {
       ...
       Post.updateOne(declinedPost ,{ $set : {verified : 3 , declineReason : declineReason  }})
       .then((result)=>
       {
           res.json({ result, })
...
exports.EditPost= async (req , res ) => {
       ...
       Post.updateOne(EditablePost ,{$set : { PricePerNight : PricePerNight , title:title , description : description  }})
        .then((result)=>
        {
            res.json({ result, })
        })
